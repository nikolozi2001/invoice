...
export default function Features() {
  const features = [
    ...
    {
      icon: Calculator,
      title: 'დ.ღ.გ. გაანგარიშება',
      description: 'ავტომატური დ.ღ.გ.-ს გაანგარიშება და დეკლარაციების მომზადება',
      benefits: ['18% დ.დ.გ. ავტოგაანგარიშება', 'მესაე დეკლარაცია', 'ექსპორტი Excel-ში']
    },
    {
      icon: TrendingUp,
